...
export default function TextForm(props) {
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="mb-3">
        <textarea className="form-control" value={text} id="myBox" onChange={handleOnChange} style={{backgroundColor: (props.mode === 'dark' ? 'rgb(36 74 104)' : 'white') , borderRadius: '20px', color:(props.mode === 'dark' ? 'white' : 'black')}} rows="8"></textarea>
      </div>
    ...
    <div className="container my-3">
      ...
      <p><b>{text.split(/\s+/).filter(word => word.trim() !== "").length}</b> words , <b>{text.length}</b> Characters</p>
